...
(function (ParseLogic) {
    var PDFPlanParser = (function () {
        ...
        PDFPlanParser.prototype.parse = function (fileName) {
            var _this = this;
            return new Promise(function (resolve, reject) {
                _this._parse(fileName, function (data) { return resolve(data); });
            });
        };
        PDFPlanParser.prototype._parse = function (fileName, readyHandler) {
            var _this = this;
